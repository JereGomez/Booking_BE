package com.example.demo.dto.salida.alojamiento;
...
public class AlojamientoSalidaDto {
    private Long id;
    ...
    public AlojamientoSalidaDto(Long id, List<Reserva> reservas, Imagenes imagenes, Categoria categoria, Ubicacion ubicacion, String nombre, String descripcion, String tipo_de_alojamiento, Long capacidad, String direccion, double precio) {
        this.id=id;
